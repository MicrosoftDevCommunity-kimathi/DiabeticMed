...
namespace DiabeticProject
{
    ...
    public partial class Patients
    {
        public static List<Patients> FromJson(string json) => JsonConvert.DeserializeObject<List<Patients>>(json, DiabeticProject.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this List<Patients> self) => JsonConvert.SerializeObject(self, DiabeticProject.Converter.Settings);
    }
